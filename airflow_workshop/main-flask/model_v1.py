...
df = pd.read_csv(r"C:\Users\Ahmed Guebsi\Downloads\Ahmed_repo\dataset\dataset_2022-08-17_10-43-50.csv")
print(df.head())
print(df.dtypes)
...
print("nettoyage")
p=df['TEXT'].apply(lambda x:nt.TextFrame(x).noise_scan())
print(p)
...
# res = [''.join(ele) for ele in multilabel.classes_]
res = list(map(''.join, multilabel.classes_))
print(str(res))
